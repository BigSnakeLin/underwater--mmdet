...
test_cfg = dict(
    rpn=dict(
        ...
        min_bbox_size=0),
    rcnn=dict(
        score_thr=0.0001, nms=dict(type='soft_nms', iou_thr=0.5, min_score=0.0001), max_per_img=100))
# dataset settings
dataset_type = 'CocoDataset'
data_root = 'data/coco/'
img_norm_cfg = dict(
    mean=[64.212, 151.620, 83.109], std=[27.648, 42.759, 44.520], to_rgb=True)
train_pipeline = [
...
log_level = 'INFO'
work_dir = 'underwaterdetect/cascade_rcnn_hrnetv2p_w32_1x'
load_from = 'checkpoints/cascade_rcnn_hrnetv2p_w32_20e_20190522-55bec4ee.pth'
resume_from = None
workflow = [('train', 1)]